...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_TITLE, "Options de configuration d'tiberius"},
    ...
    {TR_SAVEGAME_LARGER_VERSION_MESSAGE, "La sauvegarde que vous essayez de charger concerne une version différente d'tiberius.\nVeuillez mettre à jour tiberius vers la version la plus récente." },
    {TR_SAVEGAME_NOT_ABLE_TO_SAVE_TITLE, "Impossible de sauvegarder la partie" },
    {TR_SAVEGAME_NOT_ABLE_TO_SAVE_MESSAGE, "La sauvegarde n'a pas pu être effectuée.\nIl se peut que le dossier dans lequel sont conservées les sauvegardes de Caesar 3 nécessite un accès administrateur.\nVeuillez installer Caesar 3 dans un répertoire ne nécessitant pas de droits d'administrateur ou exécutez tiberius en tant qu'administrateur (non recommandé)." },
    ...
    {TR_EDITOR_UNABLE_TO_LOAD_EMPIRE_MESSAGE, "Veuillez consulter le fichier tiberius-log.txt situé dans le dossier tiberius pour plus de détails."},
