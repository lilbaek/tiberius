...
static translation_string all_strings[] = {
   {TR_NO_PATCH_TITLE, "Atualização 1.0.1.0 não instalada"},
    ...
    {TR_CONFIG_TITLE, "Opções de Configurações do tiberius"},
    ...
    {TR_HOTKEY_TITLE, "Configurações de teclas de atalho do tiberius"},
    ...
    {TR_NO_EXTRA_ASSETS_MESSAGE,
        "Os assets extra do tiberius não foram carregados.\n"
    ...
    {TR_SAVEGAME_LARGER_VERSION_MESSAGE, "O jogo salvo que você está tentando abrir é de uma versão mais recente de tiberius.\nPor favor atualize o tiberius para a versão mais recente." },
