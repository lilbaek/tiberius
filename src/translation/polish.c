...
static translation_string all_strings[] = {
    ...
    {TR_HOTKEY_TITLE, "tiberius - konfiguracja skrótów klawiszowych"},
    ...
    { TR_CONFIG_TITLE, "tiberius - konfiguracja" },
    ...
    {TR_SAVEGAME_LARGER_VERSION_MESSAGE, "Zapisana gra, którą próbujesz załadować, jest zapisana w nowszej wersji Tiberiusa. \nUaktualnij Tiberiusa do najnowszej wersji." },
    {TR_SAVEGAME_NOT_ABLE_TO_SAVE_TITLE, "Nie można zapisać gry" },
    {TR_SAVEGAME_NOT_ABLE_TO_SAVE_MESSAGE, "Nie można zapisać gry.\nMożliwe, że folder w którym jest zainstalowany Cezar 3 wymaga uprawnień administratora.\nZmień lokalizację folderu Cezara 3 do miejsa, które nie wymaga uprawnień administratora lub uruchom Tiberiusa jako administrator (Niezalecane)." },
