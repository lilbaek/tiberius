...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_TITLE, "tiberius configuration options"},
    ...
    {TR_HOTKEY_TITLE, "tiberius hotkey configuration"},
    ...
    {TR_NO_EXTRA_ASSETS_MESSAGE,
        "The extra tiberius assets could not be loaded.\n"
    ...
    {TR_SAVEGAME_LARGER_VERSION_MESSAGE, "The savegame you're trying to load is for a more recent version of tiberius.\nPlease update tiberius to the most recent version." },
    {TR_SAVEGAME_NOT_ABLE_TO_SAVE_TITLE, "Unable to save the game" },
    {TR_SAVEGAME_NOT_ABLE_TO_SAVE_MESSAGE, "It was not possible to save the game.\nIt may be because the folder where Caesar 3 keeps the savegames requires administrator access.\nPlease either change the Caesar 3 folder to a place which doesn't require administrator access or run tiberius as administrator (not recommended)." },
    ...
    {TR_EDITOR_UNABLE_TO_LOAD_EMPIRE_MESSAGE, "Please check tiberius-log.txt in your tiberius directory for details."},
