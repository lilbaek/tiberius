...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_TITLE, "tiberius-konfigurationer"},
    ...
    {TR_HOTKEY_TITLE, "tiberius kortkommandoinställningar"},
    ...
    {TR_SAVEGAME_LARGER_VERSION_MESSAGE, "Sparfilen du försöker ladda är från en nyare version av tiberius.\nVar god uppdatera tiberius till den senaste versionen." },
